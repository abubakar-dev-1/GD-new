...
export default function Footer() {
  return (
    <footer className="w-full flex justify-center bg-[#000] py-[48px]">
      <div className="flex flex-col items-center justify-center w-full max-w-[1440px] px-[48px] gap-[96px]">
        ...
        <div className="flex flex-col md:flex-row items-start justify-between w-full gap-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p
              className="text-[#FFF] text-[16px] font-[600] leading-[24px] self-stretch"
              style={{ fontFamily: "Inter" }}
            >
          ...
          <div className="flex flex-col gap-4">
            ...
            <a
              href="mailto:@gaminadevelopers.com"
              className="text-[#FFF] text-[16px] font-[600] leading-[24px] hover:text-[#D0FF71] transition-colors"
              style={{ fontFamily: "Inter" }}
            >
              @gaminadevelopers.com
            </a>
            {/* Social Icons */}
          ...
          <div className="flex flex-col gap-4">
            <h3
              className="text-[#FFF] text-[40px] font-[700] leading-[48px] w-[361px]"
              style={{ fontFamily: "Inter" }}
            >
            ...
            <form className="flex gap-[12px]">
              <input
                ...
                className="h-[48px] px-[24px] py-[8px] rounded-[999px] bg-[#191919] border border-[#191919] text-[#FFF] placeholder:text-[#999] focus:outline-none focus:border-[#D0FF71] transition-colors"
                style={{ fontFamily: "Inter" }}
              />
              <button
                type="submit"
                className="h-[48px] px-[24px] py-[8px] rounded-[999px] bg-[#FFF] border border-[#191919] text-[#191919] text-[14px] font-[500] leading-[16px] text-center hover:bg-[#D0FF71] transition-colors"
                style={{ fontFamily: "Inter" }}
              >
                Subscribe
              </button>
