      ...
      <div className="w-full max-w-[1440px]">
        <div className="relative w-full flex rounded-[28px] overflow-hidden bg-[#191919]">
          ...
          >
            <div className="flex flex-col items-start gap-[24px]">
              ...
              <p className="text-[#FFF] text-[16px] font-[400] leading-[24px]">
                From concept to code, we deliver scalable and secure software
                solutions that solve your unique challenges.
              </p>
            </div>
          ...
          <div
            ...
            style={{ fontFamily: "Inter" }}
          >
            <h1 className="text-[#FFF] text-[64px] font-[400] leading-normal">
              Blogs
            </h1>
            <p className="text-[#FFF] text-[16px] font-[400] leading-[24px]">
              From concept to code, we deliver scalable and secure software
