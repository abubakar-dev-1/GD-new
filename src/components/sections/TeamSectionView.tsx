...
const defaultMembers: TeamMember[] = [
  {
    ...
    socials: { linkedin: "#", upwork: "#", twitter: "#" },
  },
  {
    id: "2",
    name: "Ghulam Ilyas",
...
const defaultHeading = "The Minds Behind\nthe Mission";
    ...
    <section className="w-full flex justify-center py-[40px] lg:py-[80px] px-[20px] lg:px-[10px]" style={{ backgroundColor: "var(--global-bg)" }}>
      <div className="w-full max-w-[1440px]">
        ...
        <div className="mb-12 text-left">
          <h2
            className="text-[40px] lg:text-[64px] font-[700] lg:font-[600] leading-normal lg:leading-[58px] text-white mb-3 whitespace-pre-line"
              ...
              {Array.from({ length: snapCount }).map((_, index) => (
                <button
                  ...
                  className={`w-2 h-2 rounded-full transition-colors ${
                    index === selectedIndex ? "bg-[#D0FF71]" : "bg-gray-600"
                  }`}
