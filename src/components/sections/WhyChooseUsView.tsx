...
const defaultStats: Stat[] = [
  { id: 1, value: 17, suffix: "+", label: "Projects Delivered", iconPath: "/Frame_folder.svg" },
  { id: 2, value: 97, suffix: "+", label: "Products Launched", iconPath: "/Frame_rocket.svg" },
  { id: 3, value: 5, suffix: "+", label: "Years of Experience", iconPath: "/Frame_calender.svg" },
  { id: 4, value: 100, suffix: "%", label: "Client Satisfaction", iconPath: "/Frame(3).svg" },
];

const defaultHeading = "Why Choose Us";
const defaultDescription =
  "Discover the stories behind some of our most successful and innovative digital experiences.";
